...
xs, ys, isnorth, zone, Longitudes, Latitudes, IsInbounds, varnames, printnames, λs, Data_μ, Data_σ = resample_datacube(hsi)
...
img = getRGB(Data_μ, hsi.λs, ij_pixels)
...
save_resampled_hsi(
    ...
    Data_μ,
    Data_σ,
    joinpath(outpath, "hsi.h5");
    is_band_chunked=true
)
