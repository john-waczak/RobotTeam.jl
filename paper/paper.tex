...
\Title{Rapid Georeferencing n of Pushbroom Hyperspectral Imagery for Real Time Processing by an Autonomous Aerial Vehicle}
...
In this paper, we implement a procedure for rapid georeferencing of hyper-spectral imagery acquired by an autonomous aerial vehicle, and in doing so, demonstrate the feasibility of the platform for real time characterization of novel environments. 
...
\subsection{Drone based Platforms}
