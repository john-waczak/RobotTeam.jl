...
\begin{figure}[H]
    \centering
    \includegraphics[height=8cm]{./assets/orientation.eps}
    \caption{Definitions of orientation angles measured by the IMU.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=7cm]{./figures/annotated_hsi.eps}
